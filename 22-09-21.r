...
#9.Phan tich thong ke mo ta(trang 55- 71)
...
# Lenh summary co the cho chung ta tat ca thong tin thong ke ve mot bien so
summary(igfdata)
...
# Ve do thi phan phoi cho bien so cua igfdata
hist(igfdata)
length(juul)
...
#Kiem dinh phan phoi cho igfdata
